...
class Login():
    ...
    def build(self):
        ...
        loginButton = Button(loginFrame, text="Login", font=("Arial Bold", 14), fg="white",
                            background="green", command=lambda: self.loginUser(entryEmail.get(), entrySenha.get()))
    ...
    def loginUser(self, email, password):
        if not email and not password:
            ...
            try:
                db.verify_login(email, password)
            except:
                pass
